...
def goog_report_basic(client, report, date):
    ...
    report_query = (googleads.adwords.ReportQueryBuilder()
                    .Select('Date', 'Impressions', 'Clicks', 'Cost', 'VideoViews',
                            'Device', 'LocationType', 'CityCriteriaId', 'CountryCriteriaId', 'MetroCriteriaId', 'RegionCriteriaId',
                            'ExternalCustomerId', 'CampaignId')
...
for account in my_account_id:
    ...
    for date in date_list:
        ...
        my_file_name = 'goog_' + account + '_' + 'geo' + '_' + str(my_year) + str(my_month) + str(my_day) + '.csv'
